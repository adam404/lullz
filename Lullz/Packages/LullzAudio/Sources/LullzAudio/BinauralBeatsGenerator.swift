...
public class BinauralBeatsGenerator {
    
    public enum BrainwaveState: String, CaseIterable, Identifiable {
        case delta = "Delta"
        case theta = "Theta"
        case alpha = "Alpha"
        case beta = "Beta"
    ...
    public enum BinauralPreset: String, CaseIterable, Identifiable {
        ...
        public var leftFrequency: Float {
            switch self {
        ...
        public var rightFrequency: Float {
            switch self {
    ...
    public static func generateBinauralSamples(leftFreq: Float, rightFreq: Float, sampleRate: Double, time: Double) -> (left: Float, right: Float) {
